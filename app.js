...
function setLang(lang) {
  ...
  // Footer Links
  var ftLinks = qa('footer .ft-links a');
  if(ftLinks[0]&&tx.footer_book) ftLinks[0].textContent=tx.footer_book;
  if(ftLinks[1]&&tx.footer_rest) ftLinks[1].textContent=tx.footer_rest;
  if(ftLinks[2]&&tx.footer_loc) ftLinks[2].textContent=tx.footer_loc;
  if(ftLinks[3]&&tx.footer_impressum) ftLinks[3].textContent=tx.footer_impressum;
  if(ftLinks[4]&&tx.footer_datenschutz) ftLinks[4].textContent=tx.footer_datenschutz;
