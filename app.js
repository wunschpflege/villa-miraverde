...
var OV = {
  de:{info_title:'Hinweis zu den Fotos', info_body:'Die hier gezeigten Bilder sind aktuell noch Beispielbilder – unsere Villa befindet sich derzeit in der Bauphase. Eigene, echte Fotos folgen schnellstmöglich. Sie haben jetzt schon Fragen? Melden Sie sich jederzeit gern bei uns – wir freuen uns auf Sie.', info_ok:'Verstanden', info_contact:'Kontakt aufnehmen', season_high:'Hochsaison · Juni – August', season_mid:'Zwischensaison · Mai, Sep, Okt', season_incl:'✓ Glasfaser-WLAN inklusive', am_park_h:'Parkplätze', am_park_p:'In der Tiefgarage und zusätzlich vor dem Haus – inklusive', am_solar_h:'Solaranlage', am_solar_p:'Photovoltaik für nachhaltige Energie und solare Warmwasseraufbereitung', am_lift_h:'Personenaufzug', am_lift_p:'Verbindet bequem alle Etagen der Villa', faq_a4:'Das Glasfaser-WLAN ist im Preis enthalten. Die Endreinigung weisen wir transparent separat aus.', img_note:'Hinweis: Die gezeigten Bilder sind derzeit KI-generierte Visualisierungen – echte Fotos folgen in Kürze.', model_note:'Hinweis: Das 3D-Modell dient nur der Veranschaulichung und entspricht noch nicht exakt dem fertigen Haus.'},
  en:{info_title:'A note about the photos', info_body:'The images shown here are currently placeholder photos – our villa is still under construction. Real, own photos will follow as soon as possible. Already have questions? Feel free to contact us anytime – we look forward to hearing from you.', info_ok:'Got it', info_contact:'Contact us', season_high:'High Season · June – August', season_mid:'Mid Season · May, Sep, Oct', season_incl:'✓ Fibre Wi-Fi included', am_park_h:'Parking', am_park_p:'In the underground garage and in front of the house – included', am_solar_h:'Solar power', am_solar_p:'Photovoltaics for sustainable energy and solar hot-water heating', am_lift_h:'Passenger lift', am_lift_p:'Conveniently connects all floors of the villa', faq_a4:'Fibre Wi-Fi is included in the price. The final cleaning is shown transparently as a separate item.', img_note:'Note: The images shown are currently AI-generated visualisations – real photos will follow soon.', model_note:'Note: The 3D model is for illustration only and does not yet exactly match the finished house.'},
  es:{info_title:'Nota sobre las fotos', info_body:'Las imágenes que se muestran aquí son actualmente fotos de ejemplo: nuestra villa todavía está en construcción. Las fotos reales y propias llegarán lo antes posible. ¿Ya tiene preguntas? Contáctenos cuando quiera, estaremos encantadas de ayudarle.', info_ok:'Entendido', info_contact:'Contactar', season_high:'Temporada alta · Junio – Agosto', season_mid:'Temporada media · May, Sep, Oct', season_incl:'✓ WiFi de fibra incluido', am_park_h:'Aparcamiento', am_park_p:'En el garaje subterráneo y delante de la casa, incluido', am_solar_h:'Energía solar', am_solar_p:'Fotovoltaica para energía sostenible y agua caliente solar', am_lift_h:'Ascensor', am_lift_p:'Conecta cómodamente todas las plantas de la villa', faq_a4:'El wifi de fibra está incluido en el precio. La limpieza final se indica de forma transparente por separado.', img_note:'Nota: Las imágenes mostradas son actualmente visualizaciones generadas por IA; las fotos reales llegarán pronto.', model_note:'Nota: El modelo 3D es solo orientativo y aún no corresponde exactamente a la casa terminada.'},
  fr:{info_title:'À propos des photos', info_body:'Les images présentées ici sont actuellement des photos d\'exemple – notre villa est encore en construction. De vraies photos suivront dès que possible. Vous avez déjà des questions ? Contactez-nous à tout moment, avec plaisir.', info_ok:'Compris', info_contact:'Nous contacter', season_high:'Haute saison · Juin – Août', season_mid:'Moyenne saison · Mai, Sep, Oct', season_incl:'✓ Wi-Fi fibre inclus', am_park_h:'Parking', am_park_p:'Dans le garage souterrain et devant la maison – inclus', am_solar_h:'Énergie solaire', am_solar_p:'Photovoltaïque pour une énergie durable et eau chaude solaire', am_lift_h:'Ascenseur', am_lift_p:'Relie confortablement tous les étages de la villa', faq_a4:'Le Wi-Fi fibre est inclus dans le prix. Le ménage final est indiqué séparément, en toute transparence.', img_note:'Note : les images présentées sont actuellement des visualisations générées par IA – de vraies photos suivront bientôt.', model_note:'Note : le modèle 3D est purement indicatif et ne correspond pas encore exactement à la maison finie.'},
  nl:{info_title:'Even over de foto\'s', info_body:'De hier getoonde beelden zijn momenteel voorbeeldfoto\'s – onze villa is nog in aanbouw. Eigen, echte foto\'s volgen zo snel mogelijk. Heeft u nu al vragen? Neem gerust altijd contact met ons op – we horen graag van u.', info_ok:'Begrepen', info_contact:'Contact opnemen', season_high:'Hoogseizoen · Juni – Augustus', season_mid:'Tussenseizoen · Mei, Sep, Okt', season_incl:'✓ Glasvezel-wifi inbegrepen', am_park_h:'Parkeerplaatsen', am_park_p:'In de ondergrondse garage en voor het huis – inbegrepen', am_solar_h:'Zonne-energie', am_solar_p:'Fotovoltaïek voor duurzame energie en zonneboiler voor warm water', am_lift_h:'Personenlift', am_lift_p:'Verbindt comfortabel alle verdiepingen van de villa', faq_a4:'Glasvezel-wifi is bij de prijs inbegrepen. De eindschoonmaak tonen we transparant apart.', img_note:'Let op: de getoonde beelden zijn momenteel AI-gegenereerde visualisaties – echte foto\'s volgen binnenkort.', model_note:'Let op: het 3D-model dient alleen ter illustratie en komt nog niet exact overeen met het voltooide huis.'},
  pl:{info_title:'Informacja o zdjęciach', info_body:'Prezentowane tutaj zdjęcia są obecnie zdjęciami przykładowymi – nasza willa jest jeszcze w budowie. Własne, prawdziwe zdjęcia pojawią się najszybciej jak to możliwe. Masz już pytania? Skontaktuj się z nami w dowolnej chwili – z przyjemnością pomożemy.', info_ok:'Rozumiem', info_contact:'Kontakt', season_high:'Wysoki sezon · Czerwiec – Sierpień', season_mid:'Pośredni sezon · Maj, Wrz, Paź', season_incl:'✓ Światłowodowe Wi-Fi w cenie', am_park_h:'Parking', am_park_p:'W garażu podziemnym i przed domem – w cenie', am_solar_h:'Instalacja solarna', am_solar_p:'Fotowoltaika dla ekologicznej energii i solarne podgrzewanie wody', am_lift_h:'Winda osobowa', am_lift_p:'Wygodnie łączy wszystkie piętra willi', faq_a4:'Światłowodowe Wi-Fi jest wliczone w cenę. Sprzątanie końcowe wykazujemy przejrzyście osobno.', img_note:'Uwaga: prezentowane obrazy są obecnie wizualizacjami generowanymi przez SI – prawdziwe zdjęcia pojawią się wkrótce.', model_note:'Uwaga: model 3D ma charakter wyłącznie poglądowy i nie odpowiada jeszcze dokładnie gotowemu domowi.'},
  ru:{info_title:'О фотографиях', info_body:'Показанные здесь изображения сейчас являются примерными – наша вилла пока строится. Собственные, настоящие фотографии появятся в ближайшее время. Уже есть вопросы? Обращайтесь к нам в любое время, будем рады помочь.', info_ok:'Понятно', info_contact:'Связаться', season_high:'Высокий сезон · Июнь – Август', season_mid:'Межсезонье · Май, Сен, Окт', season_incl:'✓ Оптоволоконный Wi-Fi включён', am_park_h:'Парковка', am_park_p:'В подземном гараже и перед домом — включено', am_solar_h:'Солнечная энергия', am_solar_p:'Фотоэлектрика для экологичной энергии и солнечный нагрев воды', am_lift_h:'Лифт', am_lift_p:'Удобно соединяет все этажи виллы', faq_a4:'Оптоволоконный Wi-Fi включён в цену. Финальная уборка указывается отдельно и прозрачно.', img_note:'Примечание: показанные изображения сейчас являются визуализациями, созданными ИИ, — настоящие фото появятся скоро.', model_note:'Примечание: 3D-модель носит исключительно иллюстративный характер и пока не полностью соответствует готовому дому.'}
};
...
function seasonOf(m){ if(m===5||m===6||m===7) return 'high'; if(m===4||m===8||m===9) return 'mid'; return 'low'; }
...
function loadMap(){
  var box=document.querySelector('.map-box'); if(!box) return;
  box.innerHTML='<iframe src="https://maps.google.com/maps?q=Benissa,+Alicante,+Spanien&z=13&output=embed" title="Villa Las Hermanas – Benissa, Costa Blanca" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>';
}

// FAQ-Akkordeon auf/zu
function toggleFaq(el){
  var item=el.closest('.faq-item'); if(!item) return;
  var open=item.classList.contains('open');
  document.querySelectorAll('.faq-item.open').forEach(function(i){if(i!==item)i.classList.remove('open');});
  item.classList.toggle('open', !open);
}

// Warteliste: E-Mail vormerken
async function submitWaitlist(){
  ...
  if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)){ if(msgEl){msgEl.textContent='⚠︎';emailEl&&emailEl.focus();} if(emailEl) emailEl.focus(); return; }
  var tx=(T[currentLang]||T.de);
  try{
    await fetch('/api/waitlist',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({name:(nameEl&&nameEl.value||'').trim(),email:email,lang:currentLang||'de'})});
  }catch(e){}
