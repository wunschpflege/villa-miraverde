...
var OV = {
  ...
  fr:{info_title:'À propos des photos', info_body:'Les images présentées ici sont actuellement des photos d\'exemple – notre villa est encore en construction. De vraies photos suivront dès que possible. Vous avez déjà des questions ? Contactez-nous à tout moment, avec plaisir.', info_ok:'Compris', info_contact:'Nous contacter', season_high:'Haute saison · Juin – Août', season_mid:'Moyenne saison · Mai, Sep, Oct', season_incl:'✓ Wi-Fi fibre inclus', faq_a4:'Le Wi-Fi fibre est inclus dans le prix. Le ménage final est indiqué séparément, en toute transparence.', img_note:'Note : les images présentées sont actuellement des visualisations générées par IA – de vraies photos suivront bientôt.', model_note:'Note : le modèle 3D est purement indicatif et ne correspond pas encore exactement à la maison finie.'},
  nl:{info_title:'Even over de foto\'s', info_body:'De hier getoonde beelden zijn momenteel voorbeeldfoto\'s – onze villa is nog in aanbouw. Eigen, echte foto\'s volgen zo snel mogelijk. Heeft u nu al vragen? Neem gerust altijd contact met ons op – we horen graag van u.', info_ok:'Begrepen', info_contact:'Contact opnemen', season_high:'Hoogseizoen · Juni – Augustus', season_mid:'Tussenseizoen · Mei, Sep, Okt', season_incl:'✓ Glasvezel-wifi inbegrepen', faq_a4:'Glasvezel-wifi is bij de prijs inbegrepen. De eindschoonmaak tonen we transparant apart.', img_note:'Let op: de getoonde beelden zijn momenteel AI-gegenereerde visualisaties – echte foto\'s volgen binnenkort.', model_note:'Let op: het 3D-model dient alleen ter illustratie en komt nog niet exact overeen met het voltooide huis.'},
